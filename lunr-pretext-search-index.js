...
{
  "id": "subsubsec-ROC-PR-Curves-4",
  "level": "2",
  "url": "sec-Evaluating-Predictions.html#subsubsec-ROC-PR-Curves-4",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "subsubsec-ROC-PR-Curves-6",
  "level": "2",
  "url": "sec-Evaluating-Predictions.html#subsubsec-ROC-PR-Curves-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "subsubsec-ROC-PR-Curves-9",
  "level": "2",
  "url": "sec-Evaluating-Predictions.html#subsubsec-ROC-PR-Curves-9",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "subsubsec-ROC-PR-Curves-11",
  "level": "2",
  "url": "sec-Evaluating-Predictions.html#subsubsec-ROC-PR-Curves-11",
  "type": "Table",
  "number": "2.5.1",
  "title": "",
  "body": "   Aspect  ROC Curve  PR Curve    X-axis  FPR = FP \/ (FP + TN)  Recall = TP \/ (TP + FN)    Y-axis  TPR = Recall = TP \/ (TP + FN)  Precision = TP \/ (TP + FP)    Focus  Discrimination between positives and negatives overall  Performance on positive class, correctness of positive predictions    Effect of class imbalance  Low; ROC may look optimistic in rare positives  High; PR shows poor precision when positives are rare    Use case  General model comparison; balanced datasets  Imbalanced datasets or when positive-class performance is critical    "
},
{
